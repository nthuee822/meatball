...
ACCEL_RATE = 1.0            # 加速度限制 (1.0 = 每秒變化 100%)
...
- **直直往前 (vy=+1.0, vx=0)**:  
  v1=+1.0, v2=-0.5, v3=-0.5 ✓

- **直直往右 (vx=+1.0, vy=0)**:  
  v1=0, v2=+0.866, v3=-0.866 ✓

- **斜向移動 (vx=0.5, vy=0.5)**:  
  v1=+0.5, v2=+0.183, v3=-0.683 ✓
...
1. **無旋轉功能**: 徑向輪配置物理限制，無法產生自轉力矩
2. **手把相容性**: 僅測試過 Logitech F710，其他手把可能需調整按鈕映射
3. **平台限制**: SPI 版本僅支援 Raspberry Pi
